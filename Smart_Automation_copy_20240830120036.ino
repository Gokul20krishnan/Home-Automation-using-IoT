...
#define BOTtoken ""  // Bot token in the xxxxx format: xxxxxxxxxxxxxxx, start a conversation with the bot "BotFather" in Telegram and,
                                            // follow the instructions to create a new bot. You will be given a secret token. Do not tell it to anyone.
char ssid[] = "";         // Wifi SSID 
char password[] = "";     // Wifi Password
String buttons[] = {"Light", "Fan"};  // names of connected devices, DOES NOT WORK with Cyrillic!
